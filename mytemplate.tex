...
\begin{table}[!h]
  \begin{flushright}
    \begin{tabular}{rl}
      \textbf{Class}   & \underline{\textbf{ $metadata.writer.class$ }\hspace{1cm}} \\
      \textbf{Group}   & \underline{\textbf{ $metadata.writer.group$ }\hspace{1cm}} \\
      \textbf{Chief}   & \underline{\textbf{ $metadata.writer.chief$ }\hspace{1cm}} \\
      \textbf{Partner} & \underline{\textbf{ $metadata.partners.collaborator1$ }\hspace{1cm}} \\
                       & \underline{\textbf{ $metadata.partners.collaborator2$ }\hspace{1cm}} \\
                       & \underline{\textbf{ $metadata.partners.collaborator3$ }\hspace{1cm}} \\
                       & \underline{\textbf{ $metadata.partners.collaborator4$ }\hspace{1cm}}
    \end{tabular}
  \end{flushright}
\end{table}
...
\begin{table}[!h]
  \begin{flushright}
    \begin{tabular}{rl}
      \textbf{No}   & \underline{\textbf{ $metadata.writer.no$ }\hspace{1cm}} \\
      \textbf{Name} & \underline{\textbf{ $metadata.writer.name$ }\hspace{1cm}}
    \end{tabular}
  \end{flushright}
\end{table}
