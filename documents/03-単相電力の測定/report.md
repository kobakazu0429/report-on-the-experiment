...
1. $R, R_1$: スライド抵抗器 $28\unit{\Omega}, 5\unit{A}$
1. $R_2$: スライド抵抗器 $310\unit{\Omega}, 1.5\unit{A}$
1. $X_L$: 供試リアクトル $1 ～ 100\unit{\Omega}$
1. $A, A_1, A_2, A_3$: 交流電流計 $1/5\unit{A}$ 3 台
1. $V, V_1, V_2, V_3$: 交流電圧計 $150/300\unit{V}$ 3 台
1. W: 低力率用電力計 No.3
1. スライダック $130\unit{V}, 5\unit{A}$
1. A.C.SW: 交流用スイッチ
1. S: 切替スイッチ
1. 交流定電圧電源(机上)
