...
1. 時定数について, 理論式より求められたものと, (4.27)式により求められたものを比較し検討せよ.
   ...
   \begin{eqnarray*}
   \tau &=& 1.008 \times 103 \times 80.118 \times 10^{－6} \\
   &=& 0.08076 \unit{s}
   \end{eqnarray*}

   また,(4.27)式より
   \begin{eqnarray*}
   \tau &=& \frac{1}{2.3 \frac{{\log}_{10}0.00168 - {\log}_{10}0.00112}{0.140 - 0.100}} \\
   &=& 0.09876 \unit{s}
   \end{eqnarray*}

   $C = 33 \unit{\micro F}$ のときの時定数は論理式より,
   \begin{eqnarray*}
   \tau &=& 1.008 \times 103 \times 28.224 \times 10^{-6} \\
   &=& 0.02844 \unit{s}
   \end{eqnarray*}

   また,(4.27)式より,
   \begin{eqnarray*}
   \tau &=& \frac{1}{2.3 \frac{{\log}_{10}0.0016 - {\log}_{10}0.00064}{0.080-0.050}} \\
   &=& 0.03277 \unit{s}
   \end{eqnarray*}
